...
ORDER BY Name";
    ...
    SELECT COUNT(DISTINCT H.Id) AS totalcount
        FROM Suppliers H
LEFT OUTER JOIN SupplierGroups SG ON H.SupplierGroupId = SG.Id
...
";
                ...
                data = KendoGrid<SupplierVM>.GetTransactionalGridData_CMD(options, sqlQuery, "H.Id", conditionalFields, conditionalValues);
        ...
        //                {
        //                    filterCondition = " AND (" +
        //                        GridQueryBuilder<SupplierVM>.FilterCondition(options.filter) +
        //                        ")";
        //                }
        ...
        //                var data = KendoGrid<SupplierVM>.GetGridData_CMD(options, sqlQuery, "H.Id");
