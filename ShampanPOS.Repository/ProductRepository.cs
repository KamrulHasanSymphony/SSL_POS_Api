...
namespace ShampanPOS.Repository
{
    ...
    public class ProductRepository : CommonRepository
    {
        ...
        (
            Code, Name,BarCode,BranchId,CompanyId,UserId, ProductGroupId, BanglaName, Description, UOMId, HSCodeNo,VATRate,SDRate,PurchasePrice,SalePrice, 
    ...
    string.IsNullOrWhiteSpace(vm.BarCode)
        ...
        UPDATE Products
        SET
            Code = @Code, Name = @Name,BarCode=@BarCode, BranchId = @BranchId,CompanyId = @CompanyId, ProductGroupId = @ProductGroupId, BanglaName = @BanglaName, VATRate= @VATRate,SDRate= @SDRate,PurchasePrice=@PurchasePrice,SalePrice= @SalePrice,
        ...
        public async Task<ResultVM> ListAsDataTable(string[] conditionalFields, string[] conditionalValues, PeramModel vm = null, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                string query = @"
SELECT
    Id, Code, Name,BarCode, ProductGroupId, BanglaName, Description, UOMId, HSCodeNo, 
...
ORDER BY Name";
        ...
        //WHERE H.IsArchive != 1
        //        AND H.CompanyId = " + options.CompanyId + @"
        //        " + (options.filter.Filters.Count > 0
        //                    ? " AND (" + GridQueryBuilder<ProductVM>.FilterCondition(options.filter) + ")"
        //                    : "") + @"
        ...
        //        WHERE rowindex > " + options.skip + @"
        //        AND (" + options.take + @" = 0 OR rowindex <= " + options.take + @")
        //        ";
    ...
    SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                {
                    filterCondition = " AND (" +
                        GridQueryBuilder<ProductVM>.FilterCondition(options.filter) +
                        ")";
                }
...
";
                ...
                var data = KendoGrid<ProductVM>.GetGridData_CMD(options, sqlQuery, "H.Id");
