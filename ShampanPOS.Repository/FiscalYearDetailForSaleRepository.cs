...
namespace ShampanPOS.Repository
{
    ...
    public class FiscalYearDetailForSaleRepository : CommonRepository
    {
        // Insert Method
        public async Task<ResultVM> Insert(FiscalYearDetailForSaleVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                string query = @"
INSERT INTO FiscalYearDetailForSales
                    (
        ...
        // Update Method
        public async Task<ResultVM> Update(FiscalYearDetailForSaleVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            bool isNewConnection = false;
            ...
            try
            {
                ...
                string query = @"
UPDATE FiscalYearDetailsForSale
SET 
...
WHERE 1 = 1";
                ...
                var modelList = dataTable.AsEnumerable().Select(row => new FiscalYearDetailForSaleVM
                {
                    Id = row.Field<int>("Id"),
