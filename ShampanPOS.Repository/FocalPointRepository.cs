...
namespace ShampanPOS.Repository
{
    ...
    public class FocalPointRepository : CommonRepository
    {
        // Insert Method
        public async Task<ResultVM> Insert(FocalPointVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                string query = @"
INSERT INTO FocalPoint 
(
 Code, Name, BanglaName,BranchId,IsArchive, IsActive, CreatedBy, CreatedOn, CreatedFrom
)
VALUES 
(
 @Code, @Name, @BanglaName,@BranchId, @IsArchive, @IsActive, @CreatedBy, @CreatedOn, @CreatedFrom
...
SELECT SCOPE_IDENTITY();";
        ...
        // Update Method
        public async Task<ResultVM> Update(FocalPointVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            bool isNewConnection = false;
...
UPDATE FocalPoint 
SET 
 Name=@Name, BanglaName=@BanglaName,  IsArchive=@IsArchive, IsActive=@IsActive, 
...
WHERE Id = @Id";
        ...
        public async Task<ResultVM> Delete(CommonVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                string query = $"UPDATE FocalPoint SET IsArchive = 1, IsActive = 0 WHERE Id IN ({inClause})";
        ...
        public async Task<ResultVM> List(string[] conditionalFields, string[] conditionalValues, PeramModel vm = null, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                var model = new List<FocalPointVM>();
                foreach (DataRow row in dataTable.Rows)
                {
                    model.Add(new FocalPointVM
                    {
                        Id = row.Field<int>("Id"),
        ...
        public async Task<ResultVM> ListAsDataTable(string[] conditionalFields, string[] conditionalValues, PeramModel vm = null, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                string query = @"
SELECT
 Id, Code, Name, BanglaName, BranchId,IsArchive, IsActive, CreatedBy, CreatedOn, 
 LastModifiedBy, LastModifiedOn
FROM FocalPoint WHERE 1 = 1";
...
ORDER BY Name";
        ...
        public async Task<ResultVM> GetGridData(GridOptions options , string[] conditionalFields, string[] conditionalValues,SqlConnection conn, SqlTransaction transaction)
        {
            ...
            try
            {
                ...
                var data = new GridEntity<FocalPointVM>();
    ...
    -- Count query
         ...
         where  H.IsArchive != 1
    " + (options.filter.Filters.Count > 0 ? " AND (" + GridQueryBuilder<FocalPointVM>.FilterCondition(options.filter) + ")" : "");
...
";
                ...
                data = KendoGrid<FocalPointVM>.GetTransactionalGridData_CMD(options, sqlQuery, "H.Id", conditionalFields, conditionalValues);
