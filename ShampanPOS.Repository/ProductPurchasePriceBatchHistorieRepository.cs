...
namespace ShampanPOS.Repository
{
    ...
    public class ProductPurchasePriceBatchHistorieRepository : CommonRepository
    {
        // Insert Method
        ...
        public async Task<ResultVM> Insert(ProductBatchHistoryVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                string query = @"
        INSERT INTO ProductPurchasePriceBatchHistories
        (
            ProductId, BranchId, BatchNo, EntryDate, MFGDate, EXPDate,EffectDate, 
        ...
        public async Task<ResultVM> Update(ProductBatchHistoryVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                string query = @"
UPDATE ProductPurchasePriceBatchHistories
SET 
    --ProductId = @ProductId, 
    --BranchId = @BranchId, 
    BatchNo = @BatchNo, 
...
WHERE Id = @Id";
        ...
        public async Task<ResultVM> List(string[] conditionalFields, string[] conditionalValues, PeramModel vm = null, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                FROM ProductPurchasePriceBatchHistories H  
...
";
        ...
        //public async Task<ResultVM> GetProductByProductId(int productId, SqlConnection conn, SqlTransaction transaction)
        //{
        //    bool isNewConnection = false;
        //    ResultVM result = new ResultVM { Status = "Fail", Message = "Error", ExMessage = null };
        ...
        //        // Define the query to retrieve the product by ProductId
        //        string query = @"
        //    SELECT Id, Name, Code
        //    FROM Products
        //    WHERE Id = @ProductId";  // Added condition to filter by ProductId

        //        // Set up the SQL command
        //        using (SqlCommand command = new SqlCommand(query, conn))
        //        {
        //            // Add the productId as a parameter to prevent SQL injection
        ...
        //                result.Message = "No product found with the given ProductId.";
        //            }
        //        }
        ...
        //    {
        //        result.ExMessage = ex.Message;
        //        result.Message = "Error occurred while fetching product data.";
        //        return result;
        //    }
        //    finally
        //    {
        //        // Ensure the connection is closed if it was newly opened
        //        if (isNewConnection && conn != null)
        //        {
        //            conn.Close();
        //        }
