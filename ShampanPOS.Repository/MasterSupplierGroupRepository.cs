...
namespace ShampanPOS.Repository
{
    ...
    public class MasterSupplierGroupRepository : CommonRepository
    {

        
        // Insert Method
        public async Task<ResultVM> Insert(MasterSupplierGroupVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
...
INSERT INTO MasterSupplierGroup 
(
 Code
,Name
,Description
...
SELECT SCOPE_IDENTITY();";
        ...
        // Update Method
        public async Task<ResultVM> Update(MasterSupplierGroupVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            bool isNewConnection = false;
 ...
 WHERE Id = @Id";
        ...
        public async Task<ResultVM> Delete(CommonVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                string query = $" UPDATE MasterSupplierGroup SET IsArchive = 1, IsActive = 0,LastModifiedBy = @LastModifiedBy,LastUpdateFrom = @LastUpdateFrom ,LastModifiedOn =GETDATE() WHERE Id IN ({inClause})";
...
ORDER BY Name";
        ...
        public async Task<ResultVM> GetGridData(GridOptions options, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                var data = new GridEntity<MasterSupplierGroupVM>();
                ...
                " + (options.filter.Filters.Count > 0 ? " AND (" + GridQueryBuilder<MasterSupplierGroupVM>.FilterCondition(options.filter) + ")" : "") + @"
            ...
            ";
                ...
                data = KendoGrid<MasterSupplierGroupVM>.GetGridData_CMD(options, sqlQuery, "H.Id");
