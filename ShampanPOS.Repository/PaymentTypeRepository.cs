...
namespace ShampanPOS.Repository
{
    ...
    public class PaymentTypeRepository : CommonRepository
    {
        // Insert Method
       
        public async Task<ResultVM> Insert(PaymentTypeVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
        ...
        (
            Name, IsArchive, IsActive, CreatedBy, CreatedOn
        )
        VALUES
        (
            @Name, @IsArchive, @IsActive, @CreatedBy, @CreatedOn
        ...
        public async Task<ResultVM> Update(PaymentTypeVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            bool isNewConnection = false;
        ...
        UPDATE PaymentTypes
        SET 
            Name=@Name, IsArchive=@IsArchive, IsActive=@IsActive, 
        ...
        public async Task<ResultVM> Delete(CommonVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                string query = $"UPDATE PaymentTypes SET IsArchive = 1, IsActive = 0,LastModifiedBy = @LastModifiedBy,LastUpdateFrom = @LastUpdateFrom ,LastModifiedOn =GETDATE() WHERE Id IN ({inClause})";
...
1 = 1";
        ...
        public async Task<ResultVM> ListAsDataTable(string[] conditionalFields, string[] conditionalValues, PeramModel vm = null, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                string query = @"
SELECT
    Id, Name, IsArchive, IsActiveStatus, CreatedBy, CreatedOn, 
    LastModifiedBy, LastModifiedOn
FROM PaymentTypes WHERE 1 = 1";
...
ORDER BY Name";
        ...
        public async Task<ResultVM> GetGridData(GridOptions options, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                var data = new GridEntity<PaymentTypeVM>();
                ...
                -- Count query
                 ...
                 " + (options.filter.Filters.Count > 0 ? " AND (" + GridQueryBuilder<PaymentTypeVM>.FilterCondition(options.filter) + ")" : "") + @"
            ...
            ";
                ...
                data = KendoGrid<PaymentTypeVM>.GetGridData_CMD(options, sqlQuery, "H.Id");
