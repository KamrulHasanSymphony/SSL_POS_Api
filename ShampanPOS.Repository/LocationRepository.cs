...
namespace ShampanPOS.Repository
{
    ...
    public class LocationRepository : CommonRepository
    {
        // Insert Method
        public async Task<ResultVM> Insert(LocationVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
        ...
        (
            Code, Name, ParentId, EnumType, IsArchive, IsActive, 
            CreatedBy, CreatedOn
        )
        VALUES 
        (
        ...
        public async Task<ResultVM> Update(LocationVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            bool isNewConnection = false;
        ...
        UPDATE Locations 
        SET 
            Code=@Code, Name=@Name, ParentId=@ParentId, EnumType=@EnumType, 
        ...
        WHERE Id = @Id";
                ...
                using (SqlCommand cmd = new SqlCommand(query, conn, transaction))
                {
                    ...
                    cmd.Parameters.AddWithValue("@ParentId", vm.ParentId);
                    cmd.Parameters.AddWithValue("@EnumType", vm.EnumType ?? (object)DBNull.Value);
                    //cmd.Parameters.AddWithValue("@EnumTypeId", vm.EnumTypeId ?? (object)DBNull.Value);
                    cmd.Parameters.AddWithValue("@IsArchive", vm.IsArchive);
                    cmd.Parameters.AddWithValue("@IsActive", vm.IsActive);
        ...
        public async Task<ResultVM> Delete(CommonVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                string query = $"UPDATE Locations SET IsArchive = 1, IsActive = 0,LastModifiedBy = @LastModifiedBy,LastUpdateFrom = @LastUpdateFrom ,LastModifiedOn =GETDATE() WHERE Id IN ({inClause})";
...
WHERE 
    1 = 1";
                ...
                var modelList = dataTable.AsEnumerable().Select(row => new LocationVM
                {
                   ...
                   // EnumType = Convert.ToInt32(row["EnumTypeId"]),
                    ...
                    LastUpdateFrom = row["LastUpdateFrom"]?.ToString(), // Nullable field
                }).ToList();
        ...
        public async Task<ResultVM> ListAsDataTable(string[] conditionalFields, string[] conditionalValues, PeramModel vm = null, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                string query = @"
SELECT
    Id, Code, Name, ParentId, EnumTypeId, IsArchive, IsActiveStatus, 
...
ORDER BY Name";
        ...
        public async Task<ResultVM> GetGridData(GridOptions options, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                var data = new GridEntity<LocationVM>();
               ...
               -- Count query
                ...
                " + (options.filter.Filters.Count > 0 ? " AND (" + GridQueryBuilder<LocationVM>.FilterCondition(options.filter) + ")" : "") + @"
            ...
            ";
                ...
                data = KendoGrid<LocationVM>.GetGridData_CMD(options, sqlQuery, "H.Id");
            ...
            try
            {
                ...
                string query = @"
                                SELECT 
                                    ...
                                    ISNULL(H.IsArchive, 0) AS IsArchive,
                                    ISNULL(H.IsActive, 0) AS IsActive,
			                        ISNULL(EParent.Name,'N/A') AS EnumName,
                                    ISNULL(H.CreatedBy, '') AS CreatedBy,
                                    ISNULL(FORMAT(H.CreatedOn, 'yyyy-MM-dd HH:mm'), '1900-01-01') AS CreatedOn,
                                    ISNULL(H.LastModifiedBy, '') AS LastModifiedBy,
                                    ISNULL(FORMAT(H.LastModifiedOn, 'yyyy-MM-dd HH:mm'), '1900-01-01') AS LastModifiedOn,
