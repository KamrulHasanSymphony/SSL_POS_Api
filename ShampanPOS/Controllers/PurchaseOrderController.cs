...
namespace ShampanPOS.Controllers
{
    ...
    public class PurchaseOrderController : ControllerBase
    {
        ...
        // POST: api/PurchaseOrder/SummaryReport
        ...
        public async Task<ResultVM> SummaryReport(CommonVM vm)
        {
            ...
            try
            {
                ...
                resultVM = await _purchaseOrderService.SummaryReport(new[] { "M.BranchId", "M.IsPost" }, new[] { vm.BranchId, vm.IsPost.ToLower() == "false" ? "0" : "1"}, param);
                return resultVM;
            }
            catch (Exception ex)
            {
