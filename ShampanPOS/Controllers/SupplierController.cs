...
namespace ShampanPOS.Controllers
{
    ...
    public class SupplierController : ControllerBase
    {
        ...
        public async Task<ResultVM> Insert(SupplierVM supplier)
        {
            ...
            try
            {
                resultVM = await _supplierService.Insert(supplier);
                return resultVM;
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResultVM> Update(SupplierVM supplier)
        {
            ...
            {
               _supplierService = new SupplierService();
                resultVM = await _supplierService.Update(supplier);
                return resultVM;
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResultVM> Delete(CommonVM vm)
        {
            ...
            try
            {
               _supplierService = new SupplierService();
                ...
                resultVM = await _supplierService.Delete(vm);
                return resultVM;
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResultVM> List(CommonVM vm)
        {
            ...
            {
               _supplierService = new SupplierService();
                resultVM = await _supplierService.List(new[] { "M.Id" }, new[] { vm.Id}, null);
                return resultVM;
            }
            catch (Exception ex)
            {
        ...
        // GET: api/Supplier/ListAsDataTable
        [HttpGet("ListAsDataTable")]
        public async Task<ResultVM> ListAsDataTable(SupplierVM supplier)
        {
            ResultVM resultVM = new ResultVM { Status = "Fail", Message = "Error", ExMessage = null, Id = "0", DataVM = null };
            try
            {
                _supplierService = new SupplierService();
                resultVM = await _supplierService.ListAsDataTable(new[] { "" }, new[] { "" });
                return resultVM;
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResultVM> Dropdown()
        {
            ...
            {
                 _supplierService = new SupplierService();
                resultVM = await _supplierService.Dropdown(); // Adjust if Dropdown requires a different method
                return resultVM;
            }
            catch (Exception ex)
            {
        ...
        public async Task<FileStreamResult> ReportPreview(CommonVM vm)
        {
            ...
            try
            {
                ...
                var resultVM = await _supplierService.ReportPreview(new[] { "H.Id", "H.BranchId" }, new[] { vm.Id, vm.BranchId }, peramModel);
        ...
        public async Task<ResultVM> InsertFromMasterSupplier(SupplierVM supplier)
        {
            ...
            try
            {
                resultVM = await _supplierService.InsertFromMasterSupplier(supplier);
                return resultVM;
            }
            catch (Exception ex)
            {
