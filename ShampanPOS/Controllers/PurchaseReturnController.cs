...
namespace ShampanPOS.Controllers
{
    ...
    public class PurchaseReturnController : ControllerBase
    {
        ...
        public async Task<ResultVM> GetGridData(GridOptions options)
        {
            ...
            {
                _service = new PurchaseReturnService();
                resultVM = await _service.GetGridData(options, new[] { "H.BranchId", "H.IsPost", "H.PurchaseReturnDate between", "H.PurchaseReturnDate between" }, new[] { options.vm.BranchId.ToString(), options.vm.IsPost.ToString(), options.vm.FromDate.ToString(), options.vm.ToDate.ToString() });
                return resultVM;
            }
            catch (Exception ex)
            {
